...
formInputs.forEach((inputName)=>{
    ...
    if (inputName === "office") {
        ...
        const selectOptions = options.map((city)=>`<option value=${city}>
        ${city}
      </option>`).join("");
...
saveButton.addEventListener("click", (e)=>{
    ...
    formData.forEach(([inputName, value])=>{
        ...
        if (inputName === "salary") cellValue = new Intl.NumberFormat("en-US", {
            style: "currency",
            currency: "USD",
...
tBody.addEventListener("dblclick", (e)=>{
    ...
    if (cellName === "age" || cellName === "salary") input.setAttribute("type", "number");
